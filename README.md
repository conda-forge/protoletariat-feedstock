...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/protoletariat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14663&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/protoletariat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `protoletariat` can be installed with:

```
conda install protoletariat
```

It is possible to list all of the versions of `protoletariat` available on your platform with:
